...
def launch_etl():
    ...
    es.indices.create(index=index_movies, body={'settings': es_settings}, ignore=400)
    ...
    es.indices.create(index=index_genres, body={'settings': es_settings}, ignore=400)
    load_genres = load()
    ...
    es.indices.create(index=index_persons, body={'settings': es_settings}, ignore=400)
    load_persons = load()
